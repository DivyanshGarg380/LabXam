...
export const queryCache = new Map<string, { data: { question: string; section: string; year: string; uploaded_at: number }[]; timestamp: number }>();
...
export const fetchQuestions = async (
    ...
    try {
        ...
        const result: { question: string; section: string; year: string; uploaded_at: number }[] = [];
        data.forEach((row) => {
